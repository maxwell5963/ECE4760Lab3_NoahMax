 ...
 ******************************************************************************/
 ...
 const uint16_t mario_base[MARIO_H][MARIO_W] = {
     ...
     {TR, TR, TR, TR, TR, TR, TR, TR, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, TR, TR, TR, TR, TR, TR, TR, TR, TR, TR},
     {TR, TR, TR, TR, TR, TR, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, TR, TR, TR, TR, TR, TR, TR, TR, TR, TR},
     {TR, TR, TR, TR, TR, TR, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, TR, TR, TR, TR, TR},
     {TR, TR, TR, TR, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, TR, TR, TR},
     {TR, TR, TR, TR, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, DB, TR, TR, TR},
